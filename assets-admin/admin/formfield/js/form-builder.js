        ...
        r.m = e,
            ...
            r(r.s = 35)
                ...
                const s = function(e, t = !1) {
                    ...
                    w = function(e, t = "", r = {}) {
                        let o = y(t);
                        const { events: n } = r, i = a(r, ["events"]), l = document.createElement(e), s = {
                            string: e => {
                                l.innerHTML += e
                            },
                            object: e => {
                                const { tag: t, content: r } = e, o = a(e, ["tag", "content"]);
                ...
                class a {
                    ...
                    static loadCustom(e) {
                        let t = [];
                        if (e && (t = t.concat(e)),
                            window.fbControls && (t = t.concat(window.fbControls)), !this.fbControlsLoaded) {
                            for (const e of t)
                                e(a, a.classRegister);
                    ...
                    e.exports = o.isStandardBrowserEnv() ? {
                        write: function(e, t, r, n, i, l) {
                            ...
                            a.push(e + "=" + encodeURIComponent(t)),
                                ...
                                o.isString(i) && a.push("domain=" + i), !0 === l && a.push("secure"),
                ...
                const i = {
                        ...
                        allowStageSort: !0,
                        append: !1,
                        controlOrder: ["header", "text", "textarea", "number", "paragraph", "checkbox-group", "checkbox", "radio-group", "select", "button", "date", "file", "hidden", "autocomplete"],
                ...
                const o = {},
                    n = {
                        text: ["text", "password", "email", "color", "search"],
                        header: ["h1", "h2", "h3"],
                ...
                n.a.register(["text", "file", "date", "number"], h),
                    n.a.register(["text", "password", "email", "color", "search"], h, "text");
                class g extends h {
                    static get definition() {
                        return {
                            i18n: {
                ...
                class y {
                    ...
                    beforeStop(e, t) {
                        const r = this,
                            ...
                            i = [];
                        r.stopIndex = t.placeholder.index() - 1, !o.sortableControls && t.item.parent().hasClass("frmb-control") && i.push(!0),
                    ...
                    classNames(t, r) {
                        ...
                        if (!o)
                            return;
                        const { type: l } = r, a = o.multiple ? e(o).val() : o.value.trim().split(" "), s = {
                            button: "btn",
                            submit: "btn"
                        }[l];
                        if (s && i) {
                    ...
                    dialog(e, t = !1, r = "") {
                        ...
                        return t ? i.classList.add("positioned") : (t = {
                            ...
                            document.dispatchEvent(u.a.modalOpened), -1 !== r.indexOf("data-dialog") && document.dispatchEvent(u.a.viewData),
                            i
                    }
                    confirmRemoveAll(t) {
                        const r = this,
                    ...
                    setFieldOrder(t) {
                        if (!m.a.opts.sortableControls)
                            return !1;
                        const { sessionStorage: r, JSON: o } = window, n = [];
                    ...
                    stickyControls() {
                        const { controls: t, stage: r } = this.d, o = e(t).parent(), n = t.getBoundingClientRect(), { top: i } = r.getBoundingClientRect();
                    ...
                    removeField(t, r = 250) {
                        ...
                        if (!l.length)
                            return m.a.opts.notify.warning("No fields to remove"), !1;
                    ...
                    processActionButtons(e) {
                        const { label: t, events: r } = e, o = g(e, ["label", "events"]);
                        let n = t;
                        const i = this.data;
                ...
                const k = function(e, t, r) {
                        ...
                        const D = function(t) {
                            ...
                            T = t => {
                                const { type: r } = t, o = [], n = j.getClass(r), i = (e => {
                                    ...
                                    const n = o[e];
                                    return "radio-group" === e && Object(p.v)("toggle", n), ["header", "paragraph", "button"].includes(e) && Object(p.v)("description", n),
                        ...
                        function I(e, t) {
                            const { class: r, className: o } = t, i = x(t, ["class", "className"]);
                            let l = {
                                id: e + "-" + d.lastID,
            ...
            Object(p.a)(b.stage, "keyup change", ({target: e})=>{
                ...
                Object(p.e)(e, ".form-field").querySelector(".field-label").innerHTML = Object(p.u)(t) //used to set auto label
            }
            ),
