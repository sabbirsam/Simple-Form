...
class SFSF_Enqueue extends SFSF_BaseController{
    ...
    public function admin_enqueue($screen){
        ...
        if("toplevel_page_simple_form" == $screen || "simple-form_page_create_form" == $screen || "simple-form_page_form_data" == $screen){
            ...
            wp_enqueue_script( 'simple_form_bootstrap_min_js', $this->plugin_url .'assets/library/bootstrap.min.js',array('jquery'),1.0,true );
        ...
        if("toplevel_page_simple_form" == $screen || "simple-form_page_form_data" == $screen){
            wp_enqueue_script( 'simple_form_query_dataTables_min_js', $this->plugin_url .'assets/library/jquery.dataTables.min.js',array('jquery'),1.0,true );// datatable
            wp_enqueue_script( 'simple_form_bootstrap.bundle.min.js', $this->plugin_url .'assets/library/bootstrap.bundle.min.js',array('jquery'),1.0,true );//for action to edit/delete
            
            wp_enqueue_style( 'simple_form_jquery_dataTables.min', $this->plugin_url .'assets/library/jquery.dataTables.min.css' ); // datatable
            wp_enqueue_style( 'simple_form_bootstrap.css', $this->plugin_url .'assets/library/bootstrap.min.css' );// datatable   
