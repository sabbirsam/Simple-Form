...
class SFSF_Enqueue extends SFSF_BaseController{
    ...
    public function admin_enqueue($screen){
        ...
        if("toplevel_page_simple_form" == $screen 
            ...
            wp_enqueue_script( 'simple_form_query_dataTables_min_js', 'https://cdnjs.cloudflare.com/ajax/libs/datatables/1.10.21/js/jquery.dataTables.min.js',array('jquery'),1.0,true );// datatable
            wp_enqueue_script( 'simple_form_bootstrap2_min_js', 'https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.min.js',array('jquery'),1.0,true );
            
            wp_enqueue_script( 'simple_form_bootstrap.bundle.min.js', 'https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js',array('jquery'),1.0,true );//for action to edit/delete
            
            wp_enqueue_style( 'simple_form_jquery_dataTables.min', 'https://cdn.datatables.net/1.12.1/css/jquery.dataTables.min.css' ); // datatable
            wp_enqueue_style( 'simple_form_main2_css_style', $this->plugin_url . 'assets/admin/formfield/css/form_data.css' );
           
            wp_enqueue_style( 'simple_form_bootstrap.css', 'https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/css/bootstrap.min.css' );// datatable
         ...
         */
        wp_enqueue_script( 'simple_form_bootstrap_min_js','https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.min.js',array('jquery'),1.0,true );
        wp_enqueue_script( 'simple_form_sweetalert_js', $this->plugin_url . 'assets/admin/formfield/js/sweetalert2@11.js',array('jquery'),1.0,true );
        wp_enqueue_script( 'simple_form_jquery_ui_min_js', 'http://ajax.googleapis.com/ajax/libs/jqueryui/1.11.4/jquery-ui.min.js',null,1.0,true );
    }
     /**
     * Frontend form
     */
